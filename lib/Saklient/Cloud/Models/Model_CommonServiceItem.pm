...
package Saklient::Cloud::Models::Model_CommonServiceItem;
...
# 
# @brief 共通サービス契約を検索・作成するための機能を備えたクラス。
#*
...
sub _create_resource_impl {
	...
	my $clazz = Saklient::Util::get_by_path($obj, "CommonServiceItem.Provider.Class");
	if ($clazz eq "gslb") {
		return new Saklient::Cloud::Resources::Gslb($self->{'_client'}, $obj, $wrapped);
	}
	return new Saklient::Cloud::Resources::CommonServiceItem($self->{'_client'}, $obj, $wrapped);
}

#** @method public Saklient::Cloud::Models::Model_CommonServiceItem offset ($offset)
# 
...
#** @method public Saklient::Cloud::Models::Model_CommonServiceItem limit ($count)
# 
...
#** @method public Saklient::Cloud::Models::Model_CommonServiceItem filter_by ($key, $value, $multiple)
# 
...
#** @method public Saklient::Cloud::Models::Model_CommonServiceItem reset 
# 
...
#** @method public Saklient::Cloud::Resources::Gslb create_gslb ($protocol, $delayLoop, $weighted)
# 
# @brief null@param {string} protocol
# 
# @param int $delayLoop
# @param bool $weighted
#*
sub create_gslb {
	...
	my $ret = new Saklient::Cloud::Resources::Gslb($self->{'_client'}, undef);
	$ret->set_initial_params($protocol, $delayLoop, $weighted);
	return $ret;
}

#** @method public Saklient::Cloud::Resources::CommonServiceItem get_by_id ($id)
# 
...
#** @method public Saklient::Cloud::Resources::CommonServiceItem[] find 
# 
...
#** @method public Saklient::Cloud::Models::Model_CommonServiceItem with_name_like ($name)
# 
...
#** @method public Saklient::Cloud::Models::Model_CommonServiceItem sort_by_name ($reverse)
# 
# @brief 名前でソートします。
# 
# @todo Implement test case
