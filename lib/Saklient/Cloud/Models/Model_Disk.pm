...
package Saklient::Cloud::Models::Model_Disk;
...
#** @class Saklient::Cloud::Models::Model_Disk
# 
# @brief ディスクを検索・作成するための機能を備えたクラス。
#*
...
sub _create_resource_impl {
	...
	return new Saklient::Cloud::Resources::Disk($self->{'_client'}, $obj, $wrapped);
}

#** @method public Saklient::Cloud::Models::Model_Disk offset ($offset)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk limit ($count)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk filter_by ($key, $value, $multiple)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk reset 
# 
...
#** @method public Saklient::Cloud::Resources::Disk create 
# 
...
#** @method public Saklient::Cloud::Resources::Disk get_by_id ($id)
# 
...
#** @method public Saklient::Cloud::Resources::Disk[] find 
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk with_name_like ($name)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk with_tag ($tag)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk with_tags (@$tags)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk with_tag_dnf (@$dnf)
# 
...
#** @method public Saklient::Cloud::Models::Model_Disk sort_by_name ($reverse)
# 
# @brief 名前でソートします。
# 
# @todo Implement test case
...
#** @method public Saklient::Cloud::Models::Model_Disk with_size_gib ($sizeGib)
# 
# @brief 指定したサイズのディスクに絞り込みます。
# 
# @param int $sizeGib
#*
sub with_size_gib {
...
#** @method public Saklient::Cloud::Models::Model_Disk with_server_id ($id)
# 
# @brief 指定したサーバへ接続されているディスクに絞り込みます。
# 
# @param string $id
#*
sub with_server_id {
...
#** @method public Saklient::Cloud::Models::Model_Disk sort_by_size ($reverse)
# 
# @brief サイズでソートします。
# 
# @param bool $reverse
