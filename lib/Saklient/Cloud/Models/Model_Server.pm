...
package Saklient::Cloud::Models::Model_Server;
...
sub _create_resource_impl {
	...
	return new Saklient::Cloud::Resources::Server($self->{'_client'}, $obj, $wrapped);
}

#** @method public Saklient::Cloud::Models::Model_Server offset ($offset)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server limit ($count)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server filter_by ($key, $value, $multiple)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server reset 
# 
...
#** @method public Saklient::Cloud::Resources::Server create 
# 
...
#** @method public Saklient::Cloud::Resources::Server get_by_id ($id)
# 
...
#** @method public Saklient::Cloud::Resources::Server[] find 
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_name_like ($name)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_tag ($tag)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_tags (@$tags)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_tag_dnf (@$dnf)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server sort_by_name ($reverse)
# 
# @brief 名前でソートします。
# 
# @todo Implement test case
...
#** @method public Saklient::Cloud::Models::Model_Server with_plan ($plan)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_status ($status)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_status_up 
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_status_down 
# 
...
#** @method public Saklient::Cloud::Models::Model_Server with_iso_image ($iso)
# 
...
#** @method public Saklient::Cloud::Models::Model_Server sort_by_cpu ($reverse)
# 
# @brief 仮想コア数でソートします。
# 
# @param bool $reverse
...
#** @method public Saklient::Cloud::Models::Model_Server sort_by_memory ($reverse)
# 
# @brief メモリ容量でソートします。
# 
# @param bool $reverse
