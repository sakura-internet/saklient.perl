...
package Saklient::Cloud::Models::Model_Bridge;
...
#** @class Saklient::Cloud::Models::Model_Bridge
# 
# @brief ブリッジを検索・作成するための機能を備えたクラス。
#*
...
sub _create_resource_impl {
	...
	return new Saklient::Cloud::Resources::Bridge($self->{'_client'}, $obj, $wrapped);
}

#** @method public Saklient::Cloud::Models::Model_Bridge offset ($offset)
# 
...
#** @method public Saklient::Cloud::Models::Model_Bridge limit ($count)
# 
...
#** @method public Saklient::Cloud::Models::Model_Bridge filter_by ($key, $value, $multiple)
# 
...
#** @method public Saklient::Cloud::Models::Model_Bridge reset 
# 
...
#** @method public Saklient::Cloud::Resources::Bridge create 
# 
...
#** @method public Saklient::Cloud::Resources::Bridge get_by_id ($id)
# 
...
#** @method public Saklient::Cloud::Resources::Bridge[] find 
# 
...
#** @method public Saklient::Cloud::Models::Model_Bridge with_name_like ($name)
# 
...
#** @method public Saklient::Cloud::Models::Model_Bridge sort_by_name ($reverse)
# 
# @brief 名前でソートします。
# 
# @todo Implement test case
