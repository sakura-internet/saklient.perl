...
package Saklient::Cloud::Models::Model_Icon;
...
#** @class Saklient::Cloud::Models::Model_Icon
# 
# @brief アイコンを検索・作成するための機能を備えたクラス。
#*
...
sub _create_resource_impl {
	...
	return new Saklient::Cloud::Resources::Icon($self->{'_client'}, $obj, $wrapped);
}

#** @method public Saklient::Cloud::Models::Model_Icon offset ($offset)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon limit ($count)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon filter_by ($key, $value, $multiple)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon reset 
# 
...
#** @method public Saklient::Cloud::Resources::Icon get_by_id ($id)
# 
...
#** @method public Saklient::Cloud::Resources::Icon[] find 
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon with_name_like ($name)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon with_tag ($tag)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon with_tags (@$tags)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon with_tag_dnf (@$dnf)
# 
...
#** @method public Saklient::Cloud::Models::Model_Icon sort_by_name ($reverse)
# 
# @brief 名前でソートします。
# 
# @todo Implement test case
...
#** @method public Saklient::Cloud::Models::Model_Icon with_shared_scope 
# 
# @brief パブリックアイコンに絞り込みます。
#*
...
#** @method public Saklient::Cloud::Models::Model_Icon with_user_scope 
# 
# @brief プライベートアイコンに絞り込みます。
#*
sub with_user_scope {
	my $self = shift;
	my $_argnum = scalar @_;
