...
package Saklient::Cloud::Models::Model_Region;
...
#** @class Saklient::Cloud::Models::Model_Region
# 
# @brief リージョンを検索するための機能を備えたクラス。
#*
...
sub _create_resource_impl {
	...
	return new Saklient::Cloud::Resources::Region($self->{'_client'}, $obj, $wrapped);
}

#** @method public Saklient::Cloud::Models::Model_Region offset ($offset)
# 
...
#** @method public Saklient::Cloud::Models::Model_Region limit ($count)
# 
...
#** @method public Saklient::Cloud::Models::Model_Region filter_by ($key, $value, $multiple)
# 
...
#** @method public Saklient::Cloud::Models::Model_Region reset 
# 
...
#** @method public Saklient::Cloud::Resources::Region get_by_id ($id)
# 
...
#** @method public Saklient::Cloud::Resources::Region[] find 
# 
...
#** @method public Saklient::Cloud::Models::Model_Region with_name_like ($name)
# 
...
#** @method public Saklient::Cloud::Models::Model_Region sort_by_name ($reverse)
# 
# @brief 名前でソートします。
# 
# @todo Implement test case
