...
package Saklient::Cloud::Resources::Router;
...
#** @var private string Saklient::Cloud::Resources::Router::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resources::Router::$m_name 
# 
# @brief 名前
#*
my $m_name;

#** @var private string Saklient::Cloud::Resources::Router::$m_description 
# 
# @brief 説明
#*
my $m_description;

#** @var private int Saklient::Cloud::Resources::Router::$m_network_mask_len 
# 
# @brief ネットワークのマスク長
#*
my $m_network_mask_len;

#** @var private int Saklient::Cloud::Resources::Router::$m_band_width_mbps 
# 
# @brief 帯域幅
#*
my $m_band_width_mbps;

#** @var private string Saklient::Cloud::Resources::Router::$m_swytch_id 
# 
# @brief スイッチ
#*
my $m_swytch_id;
...
#** @method public Saklient::Cloud::Resources::Router save 
# 
...
#** @method public Saklient::Cloud::Resources::Router reload 
# 
...
# @param (Saklient::Cloud::Resources::Router, bool) => void $callback
#*
sub after_create {
	my $self = shift;
	my $_argnum = scalar @_;
...
sub add_ipv6_net {
	...
	$self->reload();
	return new Saklient::Cloud::Resources::Ipv6Net($self->{'_client'}, $result->{"IPv6Net"});
}

#** @method public Saklient::Cloud::Resources::Router remove_ipv6_net ($ipv6Net)
# 
...
sub add_static_route {
	...
	$self->reload();
	return new Saklient::Cloud::Resources::Ipv4Net($self->{'_client'}, $result->{"Subnet"});
}

#** @method public Saklient::Cloud::Resources::Router remove_static_route ($ipv4Net)
# 
...
#** @method public Saklient::Cloud::Resources::Router change_plan ($bandWidthMbps)
# 
...
#** @var private bool Saklient::Cloud::Resources::Router::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
sub id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Router#id");
		throw $ex;
	}
	return $_[0]->get_id();
}

#** @var private bool Saklient::Cloud::Resources::Router::$n_name 
# 
# @brief null
#*
my $n_name = 0;
...
#** @var private bool Saklient::Cloud::Resources::Router::$n_description 
# 
# @brief null
#*
my $n_description = 0;
...
#** @var private bool Saklient::Cloud::Resources::Router::$n_network_mask_len 
# 
# @brief null
#*
...
sub set_network_mask_len {
	...
	if (!$self->{'is_new'}) {
		{ my $ex = new Saklient::Errors::SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "Saklient::Cloud::Resources::Router#network_mask_len"); throw $ex; };
	}
...
#** @var private bool Saklient::Cloud::Resources::Router::$n_band_width_mbps 
# 
# @brief null
#*
...
sub set_band_width_mbps {
	...
	Saklient::Util::validate_type($v, "int");
	if (!$self->{'is_new'}) {
		{ my $ex = new Saklient::Errors::SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "Saklient::Cloud::Resources::Router#band_width_mbps"); throw $ex; };
	}
...
#** @var private bool Saklient::Cloud::Resources::Router::$n_swytch_id 
# 
# @brief null
#*
my $n_swytch_id = 0;
...
sub swytch_id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Router#swytch_id");
		throw $ex;
	}
