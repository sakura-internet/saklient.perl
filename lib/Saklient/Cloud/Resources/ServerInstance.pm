...
package Saklient::Cloud::Resources::ServerInstance;
...
#** @var private string Saklient::Cloud::Resources::ServerInstance::$m_status 
# 
# @brief 起動状態 {@link EServerInstanceStatus}
#*
my $m_status;

#** @var private string Saklient::Cloud::Resources::ServerInstance::$m_before_status 
# 
# @brief 前回の起動状態 {@link EServerInstanceStatus}
#*
my $m_before_status;

#** @var private NativeDate Saklient::Cloud::Resources::ServerInstance::$m_status_changed_at 
# 
# @brief 現在の起動状態に変化した日時
#*
my $m_status_changed_at;

#** @var private IsoImage Saklient::Cloud::Resources::ServerInstance::$m_iso_image 
# 
...
sub status {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::ServerInstance#status");
		throw $ex;
	}
	return $_[0]->get_status();
}

#** @var private bool Saklient::Cloud::Resources::ServerInstance::$n_before_status 
# 
# @brief null
#*
...
sub before_status {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::ServerInstance#before_status");
		throw $ex;
	}
	return $_[0]->get_before_status();
}

#** @var private bool Saklient::Cloud::Resources::ServerInstance::$n_status_changed_at 
# 
# @brief null
#*
...
sub status_changed_at {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::ServerInstance#status_changed_at");
		throw $ex;
	}
	return $_[0]->get_status_changed_at();
}

#** @var private bool Saklient::Cloud::Resources::ServerInstance::$n_iso_image 
# 
# @brief null
#*
my $n_iso_image = 0;

#** @method private Saklient::Cloud::Resources::IsoImage get_iso_image 
# 
# @brief (This method is generated in Translator_default#buildImpl)
#*
sub get_iso_image {
...
#** @method public Saklient::Cloud::Resources::IsoImage iso_image ()
# 
# @brief 挿入されているISOイメージ
#*
sub iso_image {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::ServerInstance#iso_image");
		throw $ex;
	}
...
sub api_deserialize_impl {
	...
	if (Saklient::Util::exists_path($r, "CDROM")) {
		$self->{'m_iso_image'} = !defined(Saklient::Util::get_by_path($r, "CDROM")) ? undef : new Saklient::Cloud::Resources::IsoImage($self->{'_client'}, Saklient::Util::get_by_path($r, "CDROM"));
	}
	else {
