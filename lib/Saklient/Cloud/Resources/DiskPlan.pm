...
package Saklient::Cloud::Resources::DiskPlan;
...
#** @var private string Saklient::Cloud::Resources::DiskPlan::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resources::DiskPlan::$m_name 
# 
# @brief 名前
#*
my $m_name;

#** @var private string Saklient::Cloud::Resources::DiskPlan::$m_storage_class 
# 
...
#** @var private bool Saklient::Cloud::Resources::DiskPlan::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
sub id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::DiskPlan#id");
		throw $ex;
	}
	return $_[0]->get_id();
}

#** @var private bool Saklient::Cloud::Resources::DiskPlan::$n_name 
# 
# @brief null
#*
my $n_name = 0;
...
sub name {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::DiskPlan#name");
		throw $ex;
	}
	return $_[0]->get_name();
}

#** @var private bool Saklient::Cloud::Resources::DiskPlan::$n_storage_class 
# 
# @brief null
#*
...
sub storage_class {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::DiskPlan#storage_class");
		throw $ex;
	}
