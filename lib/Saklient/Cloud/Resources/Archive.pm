...
package Saklient::Cloud::Resources::Archive;
...
#** @var private string Saklient::Cloud::Resources::Archive::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resources::Archive::$m_scope 
# 
# @brief スコープ {@link EScope}
#*
my $m_scope;

#** @var private string Saklient::Cloud::Resources::Archive::$m_name 
# 
# @brief 名前
#*
my $m_name;

#** @var private string Saklient::Cloud::Resources::Archive::$m_description 
# 
# @brief 説明
#*
my $m_description;

#** @var private string* Saklient::Cloud::Resources::Archive::$m_tags 
# 
# @brief タグ文字列の配列
#*
my $m_tags;

#** @var private Icon Saklient::Cloud::Resources::Archive::$m_icon 
# 
# @brief アイコン
#*
my $m_icon;

#** @var private int Saklient::Cloud::Resources::Archive::$m_display_order 
# 
# @brief 表示順序
#*
my $m_display_order;

#** @var private int Saklient::Cloud::Resources::Archive::$m_size_mib 
# 
# @brief サイズ[MiB]
#*
my $m_size_mib;

#** @var private string Saklient::Cloud::Resources::Archive::$m_service_class 
# 
# @brief サービスクラス
#*
my $m_service_class;

#** @var private DiskPlan Saklient::Cloud::Resources::Archive::$m_plan 
# 
# @brief プラン
#*
my $m_plan;

#** @var private string Saklient::Cloud::Resources::Archive::$m_availability 
# 
...
#** @method public Saklient::Cloud::Resources::Archive save 
# 
...
#** @method public Saklient::Cloud::Resources::Archive reload 
# 
...
sub is_available {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#is_available");
		throw $ex;
	}
...
#** @var private Resource Saklient::Cloud::Resources::Archive::$_source 
# 
# @private
#*
my $_source;
...
#** @var private FtpInfo Saklient::Cloud::Resources::Archive::$_ftp_info 
# 
# @private
#*
my $_ftp_info;

#** @method public Saklient::Cloud::Resources::FtpInfo get_ftp_info 
# 
# @brief null
#*
sub get_ftp_info {
...
#** @method public Saklient::Cloud::Resources::FtpInfo ftp_info ()
# 
# @brief FTP情報
#*
sub ftp_info {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#ftp_info");
		throw $ex;
	}
...
sub _on_after_api_deserialize {
	...
	if (defined($root)) {
		if ((ref($root) eq 'HASH' && exists $root->{"FTPServer"})) {
			...
			if (defined($ftp)) {
				$self->{'_ftp_info'} = new Saklient::Cloud::Resources::FtpInfo($ftp);
			}
		}
	}
	if (defined($r)) {
		if ((ref($r) eq 'HASH' && exists $r->{"SourceArchive"})) {
			...
			if (defined($s)) {
				my $id = $s->{"ID"};
				if (defined($id)) {
					$self->{'_source'} = new Saklient::Cloud::Resources::Archive($self->{'_client'}, $s);
				}
			}
		}
		if ((ref($r) eq 'HASH' && exists $r->{"SourceDisk"})) {
			...
			if (defined($s)) {
				my $id = $s->{"ID"};
				if (defined($id)) {
					$self->{'_source'} = Saklient::Cloud::Resources::Resource::create_with("Disk", $self->{'_client'}, $s);
				}
			}
		}
	}
...
#** @method public Saklient::Cloud::Resources::Archive open_ftp ($reset)
# 
...
#** @method public Saklient::Cloud::Resources::Archive close_ftp 
# 
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
sub id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#id");
		throw $ex;
	}
	return $_[0]->get_id();
}

#** @var private bool Saklient::Cloud::Resources::Archive::$n_scope 
# 
# @brief null
#*
my $n_scope = 0;
...
sub scope {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#scope");
		throw $ex;
	}
	return $_[0]->get_scope();
}

#** @var private bool Saklient::Cloud::Resources::Archive::$n_name 
# 
# @brief null
#*
my $n_name = 0;
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_description 
# 
# @brief null
#*
my $n_description = 0;
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_tags 
# 
# @brief null
#*
my $n_tags = 0;
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_icon 
# 
# @brief null
#*
my $n_icon = 0;
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_display_order 
# 
# @brief null
#*
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_size_mib 
# 
# @brief null
#*
my $n_size_mib = 0;
...
sub set_size_mib {
	...
	Saklient::Util::validate_type($v, "int");
	if (!$self->{'is_new'}) {
		{ my $ex = new Saklient::Errors::SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "Saklient::Cloud::Resources::Archive#size_mib"); throw $ex; };
	}
	$self->{'m_size_mib'} = $v;
	$self->{'n_size_mib'} = 1;
	return $self->{'m_size_mib'};
...
#** @var private bool Saklient::Cloud::Resources::Archive::$n_service_class 
# 
# @brief null
#*
...
sub service_class {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#service_class");
		throw $ex;
	}
	return $_[0]->get_service_class();
}

#** @var private bool Saklient::Cloud::Resources::Archive::$n_plan 
# 
# @brief null
#*
my $n_plan = 0;
...
sub plan {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#plan");
		throw $ex;
	}
	return $_[0]->get_plan();
}

#** @var private bool Saklient::Cloud::Resources::Archive::$n_availability 
# 
# @brief null
#*
my $n_availability = 0;
...
sub availability {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::Archive#availability");
		throw $ex;
	}
