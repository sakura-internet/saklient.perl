...
package Saklient::Cloud::Resources::IsoImage;
...
#** @var private string Saklient::Cloud::Resources::IsoImage::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resources::IsoImage::$m_scope 
# 
# @brief スコープ {@link EScope}
#*
my $m_scope;

#** @var private string Saklient::Cloud::Resources::IsoImage::$m_name 
# 
# @brief 名前
#*
my $m_name;

#** @var private string Saklient::Cloud::Resources::IsoImage::$m_description 
# 
# @brief 説明
#*
my $m_description;

#** @var private string* Saklient::Cloud::Resources::IsoImage::$m_tags 
# 
# @brief タグ
#*
my $m_tags;

#** @var private Icon Saklient::Cloud::Resources::IsoImage::$m_icon 
# 
# @brief アイコン
#*
my $m_icon;

#** @var private int Saklient::Cloud::Resources::IsoImage::$m_display_order 
# 
# @brief 表示順序
#*
my $m_display_order;

#** @var private int Saklient::Cloud::Resources::IsoImage::$m_size_mib 
# 
# @brief サイズ[MiB]
#*
my $m_size_mib;

#** @var private string Saklient::Cloud::Resources::IsoImage::$m_service_class 
# 
# @brief サービスクラス
#*
my $m_service_class;
...
#** @method public Saklient::Cloud::Resources::IsoImage save 
# 
...
#** @method public Saklient::Cloud::Resources::IsoImage reload 
# 
...
#** @var private FtpInfo Saklient::Cloud::Resources::IsoImage::$_ftp_info 
# 
# @private
#*
my $_ftp_info;
...
sub ftp_info {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::IsoImage#ftp_info");
		throw $ex;
	}
	return $_[0]->get_ftp_info();
}

#** @method public Saklient::Cloud::Resources::IsoImage open_ftp ($reset)
# 
...
#** @method public Saklient::Cloud::Resources::IsoImage close_ftp 
# 
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
sub id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::IsoImage#id");
		throw $ex;
	}
	return $_[0]->get_id();
}

#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_scope 
# 
# @brief null
#*
my $n_scope = 0;
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_name 
# 
# @brief null
#*
my $n_name = 0;
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_description 
# 
# @brief null
#*
my $n_description = 0;
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_tags 
# 
# @brief null
#*
my $n_tags = 0;
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_icon 
# 
# @brief null
#*
my $n_icon = 0;
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_display_order 
# 
# @brief null
#*
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_size_mib 
# 
# @brief null
#*
my $n_size_mib = 0;
...
sub set_size_mib {
	...
	Saklient::Util::validate_type($v, "int");
	if (!$self->{'is_new'}) {
		{ my $ex = new Saklient::Errors::SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "Saklient::Cloud::Resources::IsoImage#size_mib"); throw $ex; };
	}
	$self->{'m_size_mib'} = $v;
	$self->{'n_size_mib'} = 1;
	return $self->{'m_size_mib'};
...
#** @var private bool Saklient::Cloud::Resources::IsoImage::$n_service_class 
# 
# @brief null
#*
...
sub service_class {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::IsoImage#service_class");
		throw $ex;
	}
