...
package Saklient::Cloud::Resources::LicenseInfo;
...
#** @class Saklient::Cloud::Resources::LicenseInfo
# 
# @brief ライセンス種別情報。
#*


#** @var private string Saklient::Cloud::Resources::LicenseInfo::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resources::LicenseInfo::$m_name 
# 
# @brief 名前
#*
my $m_name;
...
#** @var private bool Saklient::Cloud::Resources::LicenseInfo::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
sub id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::LicenseInfo#id");
		throw $ex;
	}
	return $_[0]->get_id();
}

#** @var private bool Saklient::Cloud::Resources::LicenseInfo::$n_name 
# 
# @brief null
#*
my $n_name = 0;
...
sub api_serialize_impl {
	...
	if (scalar(@{$missing}) > 0) {
		{ my $ex = new Saklient::Errors::SaklientException("required_field", "Required fields must be set before the LicenseInfo creation: " . join(", ", @{$missing})); throw $ex; };
	}
	return $ret;
}
