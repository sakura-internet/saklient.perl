...
package Saklient::Cloud::Resources::DiskConfig;
...
#** @var private Saklient::Cloud::Client Saklient::Cloud::Resources::DiskConfig::$_client 
# 
# @private
#*
my $_client;
...
sub client {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::DiskConfig#client");
		throw $ex;
	}
	return $_[0]->get_client();
}

#** @var private string Saklient::Cloud::Resources::DiskConfig::$_disk_id 
# 
# @private
#*
my $_disk_id;
...
sub disk_id {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::DiskConfig#disk_id");
		throw $ex;
	}
	return $_[0]->get_disk_id();
}

#** @var private string Saklient::Cloud::Resources::DiskConfig::$_host_name 
# 
# @private
#*
my $_host_name;
...
#** @var private string Saklient::Cloud::Resources::DiskConfig::$_password 
# 
# @private
#*
my $_password;
...
#** @var private string Saklient::Cloud::Resources::DiskConfig::$_default_route 
# 
# @private
#*
my $_default_route;
...
#** @var private int Saklient::Cloud::Resources::DiskConfig::$_network_mask_len 
# 
# @private
#*
...
#** @var private Saklient::Cloud::Resources::Script* Saklient::Cloud::Resources::DiskConfig::$_scripts 
# 
# @private
#*
my $_scripts;

#** @method private Saklient::Cloud::Resources::Script[] get_scripts 
# 
# @brief null
#*
sub get_scripts {
...
sub scripts {
	if (1 < scalar(@_)) {
		my $ex = new Saklient::Errors::SaklientException('non_writable_field', "Non-writable field: Saklient::Cloud::Resources::DiskConfig#scripts");
		throw $ex;
	}
...
#** @method public Saklient::Cloud::Resources::DiskConfig add_script ($script)
# 
...
#** @method public Saklient::Cloud::Resources::DiskConfig write 
# 
