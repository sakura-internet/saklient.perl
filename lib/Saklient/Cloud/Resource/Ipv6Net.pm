...
#** @class Saklient::Cloud::Resource::Ipv6Net
# 
# @brief IPv6ネットワークの実体1つに対応し、属性の取得や操作を行うためのクラス。
#*


#** @var private string Saklient::Cloud::Resource::Ipv6Net::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resource::Ipv6Net::$m_prefix 
# 
# @brief ネットワークプレフィックス
#*
my $m_prefix;

#** @var private int Saklient::Cloud::Resource::Ipv6Net::$m_prefix_len 
# 
# @brief ネットワークプレフィックス長
#*
my $m_prefix_len;

#** @var private string Saklient::Cloud::Resource::Ipv6Net::$m_prefix_tail 
# 
...
#** @var private bool Saklient::Cloud::Resource::Ipv6Net::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
#** @var private bool Saklient::Cloud::Resource::Ipv6Net::$n_prefix 
# 
# @brief null
#*
my $n_prefix = 0;
...
#** @var private bool Saklient::Cloud::Resource::Ipv6Net::$n_prefix_len 
# 
# @brief null
#*
my $n_prefix_len = 0;
...
#** @var private bool Saklient::Cloud::Resource::Ipv6Net::$n_prefix_tail 
# 
# @brief null
#*
my $n_prefix_tail = 0;
