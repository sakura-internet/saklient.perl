...
#** @class Saklient::Cloud::Resource::Disk
# 
# @brief ディスクの実体1つに対応し、属性の取得や操作を行うためのクラス。
#*


#** @var private string Saklient::Cloud::Resource::Disk::$m_id 
# 
# @brief ID
#*
my $m_id;

#** @var private string Saklient::Cloud::Resource::Disk::$m_name 
# 
# @brief 名前
#*
my $m_name;

#** @var private string Saklient::Cloud::Resource::Disk::$m_description 
# 
# @brief 説明
#*
my $m_description;

#** @var private string* Saklient::Cloud::Resource::Disk::$m_tags 
# 
# @brief タグ
#*
my $m_tags;

#** @var private Icon Saklient::Cloud::Resource::Disk::$m_icon 
# 
# @brief アイコン
#*
my $m_icon;

#** @var private int Saklient::Cloud::Resource::Disk::$m_size_mib 
# 
# @brief サイズ[MiB]
#*
my $m_size_mib;

#** @var private string Saklient::Cloud::Resource::Disk::$m_service_class 
# 
# @brief サービスクラス
#*
my $m_service_class;

#** @var private DiskPlan Saklient::Cloud::Resource::Disk::$m_plan 
# 
# @brief プラン
#*
my $m_plan;

#** @var private Server Saklient::Cloud::Resource::Disk::$m_server 
# 
# @brief 接続先のサーバ
#*
my $m_server;

#** @var private string Saklient::Cloud::Resource::Disk::$m_availability 
# 
...
#** @method public Saklient::Cloud::Resource::Disk save 
# 
...
#** @method public Saklient::Cloud::Resource::Disk reload 
# 
...
#** @var private Resource Saklient::Cloud::Resource::Disk::$_source 
# 
# @private
#*
my $_source;
...
#** @method public Saklient::Cloud::Resource::Disk connect_to ($server)
# 
...
#** @method public Saklient::Cloud::Resource::Disk disconnect 
# 
...
#** @method public Saklient::Cloud::Resource::DiskConfig create_config 
# 
...
# @param (Saklient::Cloud::Resource::Disk, bool) => void $callback
#*
sub after_copy {
	my $self = shift;
	my $_argnum = scalar @_;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_id 
# 
# @brief null
#*
my $n_id = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_name 
# 
# @brief null
#*
my $n_name = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_description 
# 
# @brief null
#*
my $n_description = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_tags 
# 
# @brief null
#*
my $n_tags = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_icon 
# 
# @brief null
#*
my $n_icon = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_size_mib 
# 
# @brief null
#*
my $n_size_mib = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_service_class 
# 
# @brief null
#*
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_plan 
# 
# @brief null
#*
my $n_plan = 0;
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_server 
# 
# @brief null
#*
my $n_server = 0;

#** @method private Saklient::Cloud::Resource::Server get_server 
# 
# @brief (This method is generated in Translator_default#buildImpl)
#*
sub get_server {
...
#** @method public Saklient::Cloud::Resource::Server server ()
# 
# @brief 接続先のサーバ
#*
sub server {
...
#** @var private bool Saklient::Cloud::Resource::Disk::$n_availability 
# 
# @brief null
#*
my $n_availability = 0;
